        ...
        <ScrollView style={styles.container}>
            <View style={styles.containerTop}>
                ...
                <View>
                    ...
                    <Text style={styles.email}>usuario@cossec.com</Text>
                </View>
            </View>
            <View style={styles.containerButtons}>
                <Text style={styles.title}>Minha Conta</Text>
                <TouchableOpacity style={styles.option} onPress={() => console.log('Histórico de compras')}>
                    <Text style={styles.optionText}>Histórico de Compras</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('AddProd')}>
                    <Text style={styles.optionText}>Adicionar Produtos</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.logoutButton} onPress={() => console.log('Sair da conta')}>
